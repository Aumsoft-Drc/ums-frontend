...
import { fetchStaffById, updateStaff } from "@/redux/slices/staff-slice"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <FormField name="status">
          <FormItem>
            ...
            <Select defaultValue={staff.status} name="status">
              <FormControl>
                <SelectTrigger>
